...
sample3_mean=statistics.mean(data)
print(sample3_mean)
...
fig.add_trace(go.Scatter(x=[sample3_mean,sample3_mean],y=[0,0.2],mode="lines",name="Sample3 mean"))
fig.show()


zscore=(sample3_mean-sampling_mean)/sampling_stdev
print(zscore)
